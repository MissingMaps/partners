...
/* -------------------------------------------------------
 ...
 -------------------------------------------------------*/
var statsApi = 'https://stats.now.ohsome.org/api';
...
function generateHashtagUrl(hashtag) {
  var hashtagUrl = 'https://stats.now.ohsome.org/dashboard#hashtags=' + hashtag;
...
function getGroupActivityStats(hashtags, primaryHashtag) {
  ...
  var url = statsApi + '/stats/hashtags/' + hashtagsString;
  ...
  $.getJSON(url, function (response) {
    ...
    if ($.isEmptyObject(hashtagData)) {
      ...
      console.warn('WARNING >> None of the secondary hashtags contain any ' + 'metrics according to the ohsomeNow endpoint at ' + statsApi + '/stats/hashtags/' + hashtagsString + '. The partner graphs will not be displayed.');
    } else {
      var primaryData = hashtagData[primaryHashtag];
      var primaryBuildingCount = primaryData.buildings;
      var primaryRoadCount = Math.round(primaryData.roads);
      ...
      try {
        for (var _iterator = Object.entries(hashtagData)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {

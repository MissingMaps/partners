...
function getProjects(projects) {
  ...
  projects.forEach(function (project, i) {
    var url = 'https://tasks.hotosm.org/api/v1/project/' + project + '/summary';
...
function addMap(projectId) {
  ...
  var endpoint = 'https://tasks.hotosm.org/api/v1/project/' + projectId;
  $.getJSON(endpoint, function (taskData) {
    ...
    // Add feature layer
    var featureLayer = L.geoJson(taskData.tasks, {
...
function getUserActivityStats(hashtag) {
  ...
  var url = 'https://osm-stats-production-api.azurewebsites.net/top-users/' + hashtag;
...
function getGroupActivityStats(hashtags, primaryHashtag) {
  ...
  var url = 'https://osm-stats-production-api.azurewebsites.net/group-summaries/' + hashtagsString;
  ...
  $.getJSON(url, function (hashtagData) {
    ...
    if ($.isEmptyObject(hashtagData)) {
      ...
      console.warn('WARNING >> None of the secondary hashtags contain any ' + 'metrics according to the Missing Maps endpoint at ' + 'https://osm-stats-production-api.azurewebsites.net/group-summaries/' + hashtagsString + '. The partner graphs will not be displayed.');
    } else {

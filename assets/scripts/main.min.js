...
function getPrimaryStats(primaryhash) {
  var url = 'https://osm-stats-api.azurewebsites.net/hashtags/' + primaryhash + '/users';
...
function getUserActivityStats(hashtag) {
  ...
  var url = 'https://osm-stats-api.azurewebsites.net/top-users/' + hashtag;
...
function getGroupActivityStats(hashtags) {
  ...
  var url = 'https://osm-stats-api.azurewebsites.net/group-summaries/' + hashtagsString;
  ...
  $.getJSON(url, function (hashtagData) {
    ...
    if ($.isEmptyObject(hashtagData)) {
      ...
      console.warn('WARNING >> None of the secondary hashtags contain any ' + 'metrics according to the Missing Maps endpoint at ' + 'https://osm-stats-api.azurewebsites.net/group-summaries/' + hashtagsString + '. The partner graphs will not be displayed.');
    } else {

...
function getGroupActivityStats(hashtags, primaryHashtag) {
  ...
  $.getJSON(url, function (hashtagData) {
    ...
    if ($.isEmptyObject(hashtagData)) {
      ...
      var primaryRoadCount = primaryData.road_count_add + primaryData.road_count_mod;
      ...
      var totalSum = _hashtags.reduce(function (acc, ht) {
        ...
        if (!$.isEmptyObject(vals)) {
          var sum = vals.building_count_add + vals.building_count_mod + vals.road_count_add + vals.road_count_mod + vals.waterway_count_add + vals.poi_count_add;

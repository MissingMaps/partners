...
var tasksApi = 'https://tasks.hotosm.org/api/v1';
...
function getProjects(projects) {
  ...
  projects.forEach(function (project, i) {
    var url = tasksApi + ('/project/' + project + '/summary');
...
function addMap(projectId) {
  ...
  var endpoint = tasksApi + ('/project/' + projectId);
